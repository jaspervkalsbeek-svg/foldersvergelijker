...
class DirkScraper extends ScraperBase
{
    public function scrape(): array
    {
        $products = [];
        echo "  Scrapen van folders van Dirk...\n";

        $html = $this->fetchUrl('https://www.dirk.nl/aanbiedingen');
    ...
    private function processItems(array $items, array &$products): array
    {
        ...
        foreach ($items as $item) {
            ...
            $products[] = ['name' => $name, 'price' => $price, 'store' => 'Dirk', 'category' => $category];
        }
        return $products;
    }
